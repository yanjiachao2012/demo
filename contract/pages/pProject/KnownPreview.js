...
loader.define(function(require, exports, module) {
	...
	var params = router.getPageParams();
		...
		function show_List1(_data) {
			...
			//
			$(".sT01").html(_data.KnownPreviewInfo.KnownPreviewTotal);
			...
			var can = "#KnownPreviewList", MB = "#MB_KnownPreviewList", data = _data.IncomeNode;
			var cc_0 = $(can);
			cc_0.empty();
			MB_body = $(MB);
			...
			//人员数据
			var data2 = _data.KnownPreviewList;
			...
			for(var i0 = 0; i0 < data.length; i0++) {
				...
				for(var j0 = 0; j0 < data2.length; j0++) {
					...
					MB_2x.find(".sT20").html(d2.PeopleName);  //人员姓名
